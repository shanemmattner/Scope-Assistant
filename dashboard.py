...
#              [State('chnl_chklst_1','value'), State('chnl_chklst_2','value'), State('chnl_chklst_3','value'), State('chnl_chklst_4','value'), State('radio_sRate', 'value'), State('channel_1', 'value'), State('channel_2', 'value'), State('channel_3', 'value'), State('channel_4', 'value'), State('desc','value')])
